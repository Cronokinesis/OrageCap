            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-16">
                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                        {/* <!-- Mobile menu button--> */}
                        <button className="inline-flex items-center justify-center p-2 rounded-md text-gray-200 hover:text-white hover:bg-orange-800 focus:outline-none focus:bg-orange-800 focus:text-white transition duration-150 ease-in-out"
                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex-shrink-0">
                            <img className="block lg:hidden h-8 w-auto" src="/orange-cap-logo-bg-circle.ico" alt="Workflow logo" />
                            <img className="hidden lg:block h-8 w-auto" src="orange-cap-logo-bg-circle.ico" alt="Workflow logo" />
                        </div>
